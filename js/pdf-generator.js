...
function getPrintStyles() {
    return "font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #333; line-height: 1.3; padding: 10mm; background: white; width: 210mm; min-height: 297mm;";
}
...
function buildCV(es) {
    ...
    var html = "";
    html += "<div style='font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #333; line-height: 1.3; padding: 10mm; background: white; width: 210mm;'>";
    ...
    for (var i = 0; i < topJobs.length; i++) {
        ...
        if (job.tags && job.tags.length > 0) {
            html += "<div style='font-size: 8pt; color: #0A192F; margin-top: 3px; font-style: italic;'>" + job.tags.join(" | ") + "</div>";
        }
